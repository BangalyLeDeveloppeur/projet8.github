...
const paragrapheSecurite = (
  <div className="annonceSecurite">
    <p>
      ...
      les voyageurs, chaque logement correspond aux de sécurité établis par nos
      services. En laissant une note aussi bien l'hote qu'au locataire, cela
      permet à nos équipes de vérifer que les standarts sont bien respectés.
      Nous organisons égalemnet des ateliers sur la sécurité domestique pour nos
      hotes.
    </p>
  </div>
);
